...
class Settings(object):
    ...
    def __init__(self, root):
        ...
        self._add(StringSetting("slicecommand", "Slic3r/slic3r-console.exe $s --output $o", _("Slice command"), _("Slice command"), "External"))
        self._add(StringSetting("sliceoptscommand", "Slic3r/slic3r.exe --ignore-nonexistent-config", _("Slicer options command"), _("Slice settings command"), "External"))
